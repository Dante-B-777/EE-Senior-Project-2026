...
int main(void)
{
  ...
  // Initialize 4-motor control over UART + TIM2 PWM (CH1..CH4)
  Wheels4_Init(&hlpuart1);

  // DIR pins per your mapping:
  // FL: PB0, FR: PB1, RL: PB2, RR: PB10
  Wheels4_ConfigAll(&htim2,
                    GPIOB, GPIO_PIN_0,
                    GPIOB, GPIO_PIN_1,
                    GPIOB, GPIO_PIN_2,
                    GPIOB, GPIO_PIN_10);
